...
let LoginPage = class LoginPage {
    constructor(authSvc, toastCtrl, router, storage) {
    ...
    onLogin() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.authSvc.login(this.input.email, this.input.password).subscribe((resp) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                try {
                    if (resp.idToken) {
                        yield this.storage.set('token', this.input.email);
