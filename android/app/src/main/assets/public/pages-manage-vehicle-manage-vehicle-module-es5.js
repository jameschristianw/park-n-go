...
var AddVehicleComponent = /** @class */ (function () {
    function AddVehicleComponent(modalCtrl) {
    ...
    AddVehicleComponent.prototype.addVehicleToDB = function () {
        // this.closeModal()
        console.log("Vehicle Added");
        console.log("Closing Modal");
        this.closeModal();
    };
    AddVehicleComponent.prototype.addVehiclePicture = function () {
...
var ManageVehiclePageModule = /** @class */ (function () {
    function ManageVehiclePageModule() {
    }
    ...
    return ManageVehiclePageModule;
}());
...
var ManageVehiclePage = /** @class */ (function () {
    function ManageVehiclePage(router, manageVehicleSvc, storage) {
        this.router = router;
        this.manageVehicleSvc = manageVehicleSvc;
        this.storage = storage;
        this.vehicleList = [];
    }
    ManageVehiclePage.prototype.ngOnInit = function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.manageVehicleSvc.getVehicles(email).subscribe(function (res) {
    ...
    ManageVehiclePage.prototype.addVehicle = function () {
        console.log('Add button clicked!');
        this.router.navigateByUrl('add-vehicle').then(function (r) { return r; });
    };
    ManageVehiclePage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-manage-vehicle-manage-vehicle-module-es5.js.map