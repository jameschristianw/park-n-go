...
let HomePage = class HomePage {
    constructor(userService, storage, platform, geoLocation, managePlaceSvc) {
    ...
    ngOnInit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            yield this.managePlaceSvc.getAllPlaces().subscribe((res) => {
                this.places = res;
                ...
                this.places.forEach((it) => {
                    ...
                    const newMarker = this.map.addMarkerSync(location);
                    newMarker.on(_ionic_native_google_maps_ngx__WEBPACK_IMPORTED_MODULE_6__["GoogleMapsEvent"].MARKER_CLICK).subscribe(() => {
            ...
            yield this.loadMap(this.locLat, this.locLong);
        });
    }
    loadMap(locLat, locLong) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            const currMarker = this.map.addMarkerSync({
            ...
            currMarker.on(_ionic_native_google_maps_ngx__WEBPACK_IMPORTED_MODULE_6__["GoogleMapsEvent"].MARKER_CLICK).subscribe(() => {
                // alert('Current Location Marker Clicked !');
            });
            this.map.on(_ionic_native_google_maps_ngx__WEBPACK_IMPORTED_MODULE_6__["GoogleMapsEvent"].MAP_CLICK).subscribe(() => {
                this.cardAddress = '';
                this.cardPricePerHour = '';
                this.cardAreaName = '';
            });
...
let UserService = class UserService {
    ...
    getAllUserInfo(key) {
        const userCollection = this.db.collection('users', (ref) => ref.where('email', '==', key).limit(1));
        this.userObservable = userCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((actions) => {
        ...
        const vehiclesCollection = this.db.collection('vehicles', (ref) => ref.where('email', '==', key));
        this.vehiclesObservable = vehiclesCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((actions) => {
            return actions.map((a) => {
                const data = a.payload.doc.data();
                const id = a.payload.doc.id;
                return Object.assign({ id }, data);
        ...
        const placesCollection = this.db.collection('places', (ref) => ref.where('email', '==', key));
        this.placesObservable = placesCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((actions) => {
            return actions.map((a) => {
                const data = a.payload.doc.data();
                const id = a.payload.doc.id;
                return Object.assign({ id }, data);
