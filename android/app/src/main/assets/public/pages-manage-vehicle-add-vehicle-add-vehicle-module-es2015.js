...
let AddVehiclePage = class AddVehiclePage {
    constructor(manageVehicleSvc, loadCtrl, navCtrl, storage) {
    ...
    addVehicleToDB() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            console.log(vehicle);
            yield this.manageVehicleSvc.addVehicles(email, plate, model, type);
            // await this.manageVehicleSvc.addVehiclesByObject(vehicle);
            yield loading.dismiss();
            yield this.backToManage();
        });
    }
    backToManage() {
...
//# sourceMappingURL=pages-manage-vehicle-add-vehicle-add-vehicle-module-es2015.js.map