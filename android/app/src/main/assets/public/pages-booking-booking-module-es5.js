...
var SuccessComponent = /** @class */ (function () {
    function SuccessComponent(modalCtrl, router) {
...
var BookingPage = /** @class */ (function () {
    ...
    BookingPage.prototype.ngOnInit = function () {
        ...
        this.activatedRoute.paramMap.subscribe(function (paramMap) {
            ...
            _this.pricePerHour = Number(paramMap.get('price'));
            _this.duration = '-';
            _this.plateNo = '-';
            //
    ...
    BookingPage.prototype.calculateDuration = function (timeId) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var arrive, leave, diff;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                if (this.arrivalTimeSet && this.leavingTimeSet) {
                    ...
                    arrive = new Date(this.arrivalTime).getTime();
                    leave = new Date(this.leavingTime).getTime();
                    diff = (leave - arrive) / 3600000;
    ...
    BookingPage.prototype.changeVehicle = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var email;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        email = _a.sent();
                        return [4 /*yield*/, this.vehicleSvc.getVehicles(email).subscribe(function (res) {
                                _this.vehicleList = [];
                                _this.vehicleList = res;
                                console.log('Booking', _this.vehicleList);
                                _this.vehicleList.forEach(function (v) {
                                    console.log(v.plateNo);
                                    _this.buttons.push({
                                        text: v.plateNo,
                                        handler: function () {
                                            _this.plateNo = v.plateNo;
                                        },
                                    });
                                });
                                console.log('Buttons', _this.buttons);
                                _this.actionCtrl.create({
    ...
    BookingPage.prototype.bookingPlace = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var email, created, res, success, modal, modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        res = this.db.collection('bookings').add({
                            customerEmail: email,
                    ...
                    case 3:
                        _a.sent();
                        return [3 /*break*/, 7];
                    case 4: return [4 /*yield*/, this.modalCtrl.create({
    ...
    BookingPage.prototype.backToHome = function () {
        this.navCtrl.navigateBack('/tabs/parking').then(function (r) { return r; });
    };
    BookingPage.ctorParameters = function () { return [
