...
var ManagePlacePageModule = /** @class */ (function () {
    function ManagePlacePageModule() {
    }
...
var ManagePlacePage = /** @class */ (function () {
    function ManagePlacePage(routeCtrl, placeService, storage, loadCtrl) {
        this.routeCtrl = routeCtrl;
        this.placeService = placeService;
        this.storage = storage;
        this.loadCtrl = loadCtrl;
    }
    ManagePlacePage.prototype.ngOnInit = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        email = _a.sent();
                        this.placeService.getMyPlaces(email).subscribe(function (res) {
                            _this.places = res;
    ...
    ManagePlacePage.prototype.addPlace = function () {
        console.log('Add button clicked!');
        this.routeCtrl.navigateByUrl('/add-place');
    };
    ManagePlacePage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-manage-place-manage-place-module-es5.js.map