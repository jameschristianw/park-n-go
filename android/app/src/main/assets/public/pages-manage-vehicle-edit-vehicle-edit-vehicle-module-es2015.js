...
let EditVehiclePageModule = class EditVehiclePageModule {
};
...
let EditVehiclePage = class EditVehiclePage {
    constructor(navCtrl, loadCtrl, manageVehicleSvc, activatedRoute, storage, firestore) {
    ...
    ngOnInit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.email = yield this.storage.get('token');
            this.activatedRoute.paramMap.subscribe(paramMap => {
                ...
                const data = this.firestore.doc('vehicles/' + this.vehicleId);
    ...
    deleteVehicleFromDB() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            yield loading.present();
            yield this.manageVehicleSvc.deleteVehicle(this.vehicleId, this.email);
            yield loading.dismiss();
            this.backToManage();
        });
    }
...
EditVehiclePage.ctorParameters = () => [
...
//# sourceMappingURL=pages-manage-vehicle-edit-vehicle-edit-vehicle-module-es2015.js.map