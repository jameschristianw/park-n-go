...
var RegisterPage = /** @class */ (function () {
    function RegisterPage(authSvc, router, toastCtrl, storage) {
    ...
    RegisterPage.prototype.onRegister = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.authSvc.signup(this.user.email, this.user.password).subscribe(function (resp) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                    var newUser, error_1;
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                _a.trys.push([0, 5, , 6]);
                                if (!resp.idToken) return [3 /*break*/, 4];
                                newUser = {
                                ...
                                return [4 /*yield*/, this.authSvc.addNewUser(newUser)];
                            case 1:
                                _a.sent();
                                return [4 /*yield*/, this.storage.set('token', this.user.email)];
                            case 2:
                                _a.sent();
    ...
    RegisterPage.prototype.presentSuccessToast = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    RegisterPage.prototype.presentEmailExistToast = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
